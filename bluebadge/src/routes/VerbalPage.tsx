...
export default function VerbalPage() {
  const items = useMemo(() => shuffle(getCognitive('verbal')), [])
  ...
  if (!current) {
    return <div className="card"><h2>Verbaal redeneervermogen</h2><p>Geen items gevonden. Importeer 50+ items via Admin Import (Cognitief).</p></div>
  }

  return (
    <div className="grid">
      <div className="card">
        <h2 style={{ marginTop: 0 }}>Verbaal redeneervermogen</h2>
        <p>{current.prompt}</p>
